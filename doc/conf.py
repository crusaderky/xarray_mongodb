...
htmlhelp_basename = 'xarray_mongodbdoc'
...
latex_documents = [
  ('index', 'xarray_mongodb.tex', 'xarray_mongodb Documentation',
   'Amphora, Inc.', 'manual'),
]
...
man_pages = [
    ('index', 'xarray_mongodb', 'xarray_mongodb Documentation',
     ['Amphora, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'xarray_mongodb', 'xarray_mongodb Documentation',
   'Amphora, Inc.', 'xarray_mongodb',
   'Store xarray objects on MongoDB', 'Miscellaneous'),
]
